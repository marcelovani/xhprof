...
<script src="./third-party/three.js/examples/js/renderers/CanvasRenderer.js"></script>
...
/*
          ...
          */
          ...
          jQuery.each(g.nodes(), function( i, val ) {
            ...
            element.style.width = node.width * 80 + 150 + 'px';
            element.style.height = node.height * 80 + 150 + 'px';
