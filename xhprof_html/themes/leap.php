...
//          //.use('playback', {recording: 'finger-tap-54fps.json.lz'})
          .use('riggedHand', {
            ...
            renderFn: function(){
              ...
              //controller.plugins.transform.position.z = p;
              //console.log(controller.plugins.transform.position);
              //console.log(camera.position);
              //controller.plugins.transform.position = camera.position;
              //this.offset.z = camera.position.z;
              //console.log(this);
//              this.plugins.transform.position.set(
//                0,0,parseInt(camera.position.z, 10)
//              );
            }
