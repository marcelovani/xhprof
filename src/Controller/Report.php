...
class Report
{
                                                           ...
                                                           $run, $wts, $symbol, $sort, $run1, $run2)
    {
        ...
        if ($run) {                              // specific run to display?
            ...
            $this->profilerDiffReport($url_params,
                $xhprof_data1,
                $description1,
                $xhprof_data2,
                $description2,
    ...
    public function full_report($url_params, $symbol_tab, $sort, $run1, $run2, $links)
    {
        ...
        $this->printFlatData($url_params, $title, $flat_data, $sort, $run1, $run2, $limit);
    }
     ...
     * @author Kannan
     */
    public function printFlatData($url_params, $title, $flat_data, $sort, $run1, $run2, $limit)
    {
